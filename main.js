...
let tb9 =(parseInt(tb1))+(parseInt(tb2))+(parseInt(tb3))+(parseInt(tb4))+(parseInt(tb5))+(parseInt(tb6))+(parseInt(tb7))+(parseInt(tb8));
...
<div class="main"><div class="ram"><br><br><br><br>
    <h1>Font Rooms Bill Reading Calculator </h1>    <div class="rai">  <span id="time" class="ttime"  ></span> <span class="ttime" > Date : </span>
 </div>  </div> 
    <div>

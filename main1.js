...
// total units 
let totalunit=un1+un2+un3+un4+un5+un6+un7
...
let tb9 =(parseInt(tb1))+(parseInt(tb2))+(parseInt(tb3))+(parseInt(tb4))+(parseInt(tb5))+(parseInt(tb6))+(parseInt(tb7));



    console.log("Hello World1",p1,p2,p3,p4,p5,p6,p7);
    console.log("Hello World2",pa1,pa2,pa3,pa4,pa5,pa6,pa7);
   console.log("per person unit ",un1,un2,un3,un4,un5,un6,un7)
   console.log(" bill for person ",b1,b2,b3,b4,b5,b6,b7)
...
<div class="main"><div class="ram"><br><br><br><br>
    <h1>Nora Reading calculator</h1>    <div class="rai">  <span id="time" class="ttime"  ></span> <span class="ttime" > Date : </span>
 </div>  </div> 
    <div>
